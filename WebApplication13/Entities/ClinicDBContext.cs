    ...
    public class ClinicDBContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Navigate[] navigates = new Navigate[]
           {
            ...
            for (int i = 0; i < n; i++)
            {
                int imageNumber = i % 7 + 1; // 1 2 3 4 5 6 7
                posts[i] = new Post()
                {      
                    Id = i + 1,
                    CategoryId = i % 3 + 1, // 0 1 2  after adding 1:  1 2 3 
                    ImgSrc = $"/images/posts/{imageNumber}.jpg",
                    PostedOn = true,
                    Title = i + " Пальпация - новый метод",
                    Slogan = "Физический метод",
                    UrlSlug = "palpatio" + i,
                    DateOfPublished = DateTime.Now
                };
            }
